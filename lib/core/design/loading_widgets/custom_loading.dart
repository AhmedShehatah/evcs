...
class CustomLoading extends StatelessWidget {
  const CustomLoading({super.key, this.isTrasparent = false});
  final bool isTrasparent;
  @override
  Widget build(BuildContext context) {
    return Container(
      ...
      color: isTrasparent
          ? DIManager.findCC().transparent
          : DIManager.findCC().greyLightTextColor.withOpacity(0.5),
      child: Center(
        child: SizedBox(
