...
class $AssetsGifsGen {
  ...
  /// File path: assets/gifs/loading.json
  LottieGenImage get loading =>
      const LottieGenImage('assets/gifs/loading.json');
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/grey_add.png
  AssetGenImage get greyAdd =>
      const AssetGenImage('assets/images/grey_add.png');
  ...
  /// File path: assets/images/power_plugin.png
  AssetGenImage get powerPlugin =>
      const AssetGenImage('assets/images/power_plugin.png');
  ...
  List<AssetGenImage> get values =>
      ...
      [carPlaceholder, greyAdd, logo, man, noVehicle, onboarding, powerPlugin, visa];
